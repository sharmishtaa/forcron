...
project_root_dir = "/nas3/data/S3_Run1_Igor"
...
lowres_roughalign_stack = "Stitched_DAPI_1_Lowres_%d_to_%d_RoughAlign_1111"%(firstribbon,lastribbon)
lowres_pm_collection = "%s_%d_to_%d_DAPI_1_lowres_round1111111" %(project,firstribbon,lastribbon)
...
j = {
        ...
        "output_stack" : "%sTEST"%lowres_roughalign_stack,
...
#docker exec renderapps_testsharmi  python -m renderapps.materialize.make_downsample_image_stack --render.host ibs-forrestc-ux1 --render.client_scripts /var/www/render/render-ws-java-client/src/main/scripts --render.port 8080 --render.memGB 5G --log_level INFO  --render.project S3_Run1_Igor --render.owner S3_Run1 --input_stack Rough_Aligned_68_to_106_GFP --output_stack Stitched_GFP_Lowres_68_to_106_RoughAlign_1111 --image_directory /nas3/data/S3_Run1_Igor/processed/Low_res --pool_size 20 --scale 0.050000 --minZ 0 --maxZ 2 --numsectionsfile /nas3/data/S3_Run1_Igor/processed/Low_res/numsections
