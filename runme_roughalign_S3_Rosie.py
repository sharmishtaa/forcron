...
lowres_roughalign_stack = "Stitched_DAPI_1_Lowres_%d_to_%d_RoughAlign_1TEST"%(firstribbon,lastribbon)
lowres_pm_collection = "%s_%d_to_%d_DAPI_1_lowres_round1" %(project,firstribbon,lastribbon)
...
downsamp_str = "docker exec renderapps_testsharmi  python -m renderapps.materialize.make_downsample_image_stack --render.host ibs-forrestc-ux1 --render.client_scripts /var/www/render/render-ws-java-client/src/main/scripts --render.port 8080 --render.memGB 5G --log_level INFO  --render.project S3_Run1_Rosie --render.owner S3_Run1 --input_stack Rough_Aligned_127_to_164_GFP --output_stack Stitched_GFP_Lowres_127_to_164_RoughAlign_1TEST --image_directory /nas2/data/S3_Run1_Rosie/processed/Low_res --pool_size 20 --scale 0.050000 --minZ 0 --maxZ 746 --numsectionsfile /nas2/data/S3_Run1_Rosie/processed/Low_res/nums"
